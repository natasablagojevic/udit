...
proof -
  ...
  from this have "Q x" using assms(2) by auto 
...
proof -
  ...
  then have "konj x \<or> \<not> konj x" by auto
...
proof
  ...
  proof (rule ccontr)
    ...
    next 
      ...
      qed
    qed
    from this \<open>\<not>(A \<and> B)\<close> show False by auto 
  qed
qed
...
proof 
  ...
  proof -
    ...
    from this show "Q x" using assms(1) by auto 
  qed
qed
