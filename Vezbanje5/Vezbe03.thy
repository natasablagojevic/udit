...
text \<open>Ako svaki konj ima potkovice;\<close>
text \<open>i ako ne postoji covek koji ima potkovice;\<close>
text \<open>i ako znamo da postoji makar jedan covek;\<close>
text \<open>dokazati da postoji covek koji nije konj.\<close>
...
tranzitivna:  \<forall>x y z. R x y \<and> R y z \<longrightarrow> R x y 
