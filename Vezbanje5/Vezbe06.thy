...
proof
  ...
  proof
    assume "Greek x"
    from this assms(2) have "Man x" by simp 
    from this assms(1) show "Mortal x" by simp 
  qed
qed
...
proof - 
  ...
  proof
    ...
    proof
      from \<open>covek x\<close> show "covek x" by simp 
    next 
      show "\<not> konj x"
      proof
        assume "konj x" 
...
proof - 
  ...
  next 
    assume "\<not>konj x"
    from \<open>covek x\<close> this show "covek x \<and> \<not> konj x" by auto 
  qed
  from this show "\<exists>x. covek x \<and> \<not> konj x" by auto 
qed
...
proof
  ...
  proof
    ...
    from \<open>neparan x\<close> assms(2) have "\<not> paran x" by auto 
...
proof
  ...
  from this assms(1) have "\<not> B x" by auto 
