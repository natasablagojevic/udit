...
proof
  ...
  proof
    ...
    then have "x \<notin> A \<union> B"
      by simp 

    then have "x \<notin> A \<and> x \<notin> B"
      by simp 
...
proof
  find_theorems "_ \<or> _ \<longleftrightarrow> _ \<or> _"
  ...
  proof
    ...
    then have "x \<in> B \<or> x \<in> A"
      using HOL.disj_commute
      by simp 

    then have "x \<in> (B \<union> A)"
      by simp 
...
proof
  ...
  proof
    ...
    then have "x \<in> A \<or> x \<in> (B \<inter> C)"
      by simp 

    then have "x \<in> A \<or> (x \<in> B \<and> x \<in> C)"
      by simp 

    then have "(x \<in> A \<or> x \<in> B) \<and> (x \<in> A \<or> x \<in> C)"
      using HOL.disj_conj_distribL
      by simp 

    then have "x \<in> (A \<union> B) \<and> x \<in> (A \<union> C)"
      by simp 

    then have "x \<in> (A \<union> B) \<inter> (A \<union> C)"
      by simp 
...
next
  ...
  proof
    ...
    then have "x \<in> A \<union> (B \<inter> C)"
      by simp
...
proof 
  ...
  proof 
    ...
    then have "x \<in> A \<and> x \<in> (B \<union> C)"
      by simp 

    then have "x \<in> A \<and> (x \<in> B \<or> x \<in> C)"
      by simp 

    then have "(x \<in> A \<and> x \<in> B) \<or> (x \<in> A \<and> x \<in> C)"
      using HOL.conj_disj_distribL
      by simp 

    then have "x \<in> (A \<inter> B) \<or> x \<in> (A \<inter> C)"
      by simp 

    then have "x \<in> (A \<inter> B) \<union> (A \<inter> C)"
      by simp 
...
next 
  ...
  proof 
    ...
    then have "x \<in> A \<inter> (B \<union> C)"
      by simp 
...
proof 
  ...
  proof 
    ...
    then have "x \<in> A \<and> x \<notin> (B \<inter> C)"
      by simp 

    then have "x \<in> A \<and> (x \<notin> B \<or> x \<notin> C)"
      by simp 

    then have "(x \<in> A \<and> x \<notin> B) \<or> (x \<in> A \<and> x \<notin> C)"
      by simp 

    then have "x \<in> (A - B) \<or> x \<in> (A - C)"
      by simp

    then have "x \<in> (A - B) \<union> (A - C)"
      by simp
